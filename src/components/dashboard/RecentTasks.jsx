...
import { ArrowRight, MessageSquare, Calendar, CheckSquare } from 'lucide-react'
    ...
    <div>
      ...
      {tasks.length === 0 ? (
        <EmptyState
          icon={CheckSquare}
          title="No tasks yet"
          description="Tasks you create or get assigned will show up here."
        />
      ) : (
          ...
          <div className="divide-y divide-gray-50">
            {tasks.map(task => {
              ...
              return (
                <Link
                  key={task.id}
                  to={`/projects/${String(task.projectId)}?tab=board`}
